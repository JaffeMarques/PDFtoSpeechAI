...
OPENAI_SPEACH_SECRET = os.getenv('OPENAI_SPEACH_SECRET')
OPENAI_SPEACH_VOICE = os.getenv('OPENAI_SPEACH_VOICE', 'alloy')
OPENAI_SPEACH_MODEL = os.getenv('OPENAI_SPEACH_MODEL', 'tts-1')
