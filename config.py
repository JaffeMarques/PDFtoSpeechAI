...
ELEVENLABS_SPEACH_SECRET = os.getenv('ELEVENLABS_SPEACH_SECRET')
ELEVENLABS_SPEACH_URL = os.getenv('ELEVENLABS_SPEACH_URL', 'https://api.elevenlabs.io/v1/')
ELEVENLABS_SPEACH_VOICE_ID = os.getenv('ELEVENLABS_SPEACH_VOICE_ID')
